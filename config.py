...
MIN_PROFIT_GAP_PERCENT = Decimal('0.04')  # 2.00% minimum profit per trade

MAX_PROFIT_REDUCTION = Decimal('0.0020')  # Never reduce profit target by more than 0.10%
...
STRONG_MOMENTUM_THRESHOLD = 0.0005           # 0.5% for grid resets
MOMENTUM_RESET_COOLDOWN_MINUTES = 60        # 1 hour minimum between momentum reset
